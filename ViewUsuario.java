...
public class ViewUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tbUsuario.getColumnModel().getColumnCount() > 0) {
            tbUsuario.getColumnModel().getColumn(0).setMinWidth(90);
            tbUsuario.getColumnModel().getColumn(0).setPreferredWidth(90);
            tbUsuario.getColumnModel().getColumn(0).setMaxWidth(90);
        }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jtfLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jbSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalvarActionPerformed
        ...
        if (alterarSalvar.equals("Salvar")){
            ...
            if(controllerUsuario.atualizarUsuarioController(modelUsuario)){
                JOptionPane.showMessageDialog(this, "Registro alterardo com sucesso!","Atenção", JOptionPane.WARNING_MESSAGE);
                carregarUsuario();
                limparCampos();
                habilitarDesabilitarCampos(false);
            }else{
